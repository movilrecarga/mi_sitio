    ...
    function sendPlanByWhatsApp(plan) {
        ...
        if (!phone) {
            alert('Por favor, ingresa el número de teléfono  en el formulario de arriba.');
            return;
        }
...
//    document.getElementById('submitOrderBtn').addEventListener('click', () => {
  ...
  //      let message = `Hola, quiero solicitar una recarga.%0A%0A📱 *Número a recargar:* ${phone}%0A💰 *Monto:* $${amount} UYU%0A%0AQuedo atento a los pasos de pago.`;
 //       window.open(`https://wa.me/5355462081?text=${message}`, '_blank');
  //  });
   ...
   //         message = `Hola, quiero solicitar una recarga.%0A%0A📱 *Número a recargar:* ${phone}%0A💰 *Monto:* $${amount} CUP%0A%0AQuedo atento a los pasos de pago.`;
    //    } else {
       //     message = 'Hola, quiero solicitar información de recargas .';
     //   }
    //    window.open(`https://wa.me/5355462081?text=${message}`, '_blank');
 //   });
